...
namespace BlogApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var posts = connection.Query<Post>("SELECT * FROM posts ORDER BY created_date DESC").ToList();
        ...
        public IActionResult YorumEkle(PostComment model)
        {
            ...
            using var connection = new SqlConnection(connectionString);
            var sql = "INSERT INTO comments (Name, Comment, PostId, created_date) VALUES (@Name, @Comment, @PostId, @CreatedDate)";
            try
            {
